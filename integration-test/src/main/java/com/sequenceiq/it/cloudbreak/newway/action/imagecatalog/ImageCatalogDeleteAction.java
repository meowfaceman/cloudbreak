...
public class ImageCatalogDeleteAction implements Action<ImageCatalogEntity> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ImageCatalogDeleteAction.class);

    @Override
    public ImageCatalogEntity action(TestContext testContext, ImageCatalogEntity entity, CloudbreakClient cloudbreakClient) throws Exception {
